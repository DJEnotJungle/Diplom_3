package ru.yandex.practicum.stella.exit;
...
@DisplayName("Тест входа из аккаунта")
public class ExitTest extends BeforeTest {
    ...
    public ExitTest(String name, String email, String password) {
        this.name =name;
        this.email = email;
    ...
    @Test
    @DisplayName("Проверяем возможность выход из аккаунта")
